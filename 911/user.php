            ...
            <div class="modal-body">
              <form class="needs-validation" novalidate action="proses/proses_input_user.php" method="POST">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-8">
                    <div class="form-floating mb-3">
                      <input type="number" class="form-control" id="floatingInput" placeholder="+62xxxx" name="nohp">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-dark" name="input_user_validate" value="12345">Save
                    changes</button>
                </div>
              </form>
            </div>
            ...
            <div class="modal-body">
              <form class="needs-validation" novalidate action="proses/proses_input_user.php" method="POST">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-8">
                    <div class="form-floating mb-3">
                      <input disabled type="number" class="form-control" id="floatingInput" placeholder="+62xxxx"
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <input type="hidden" value="<?php echo $row['id'] ?>" name="id">
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">CLose</button>
                  <button type="submit" class="btn btn-dark" name="input_user_validate" value="1234">Save Changes</button>
                </div>
              </form>
            </div>
          </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <input type="hidden" value="<?php echo $row['id'] ?>" name="id">
                <div class="col-lg-12">
                  <?php
                  if($row['username'] == $_SESSION('username_911')){
                      echo "<div class='alert alert-danger'>Anda tidak dapat menghapus akun sendiri</
                      div>";
                  }else{
                ...
                <div class="modal-footer">
                  ...
                  value="1234" <?php echo ($row['username'] == $_SESSION['username_911']) ? 'disabled' : ''?>>Delete</button>
                </div>
              </form>
            </div>
          </div>
